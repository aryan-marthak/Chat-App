                ...
                <div className='flex h-screen items-center justify-center'>
                    <form onSubmit={handleSubmit(onSubmit)} className='border border-white px-6 py-3 rounded-md w-96 space-y-3'>
                        ...
                        <label className="input input-bordered flex items-center gap-2">
                            ...
                            <input {...register("ConfirmPassword", { required: true })} type="password" className="grow" placeholder="Confirm Password" />
                        </label>
                        {errors.ConfirmPassword && <span className = "text-red-600 text-sm" >**This field is required**</span>}

                        {/* Text & Button */}
                        <div className='flex justify-center'>
                            <input className='text-white bg-blue-600 cursor-pointer w-full rounded-lg py-2' type="submit" value="Signup"></input >
                        </div>
